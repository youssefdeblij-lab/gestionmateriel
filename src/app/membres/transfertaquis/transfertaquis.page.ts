...
@Component({
  selector: 'app-transfertaquis',
  templateUrl: './transfertaquis.page.html',
  styleUrls: ['./transfertaquis.page.scss'],
})
export class TransfertaquisPage implements OnInit {
          ...
          response.json()
              .then(data => {
                  ...
                  this.chantiers.forEach(element => {
                      if(element.Id){
                            fetch(environment.APiHotst + '/transferts/chantier/aquis/' + element.Id)
                            .then(response => {
                                    ...
                                    .then(data => {
                                      console.log(data);
                                       data.forEach(element2 => {
                                          if(element2.Id){ 
                                            element2.chantiervers = element.desingation;
